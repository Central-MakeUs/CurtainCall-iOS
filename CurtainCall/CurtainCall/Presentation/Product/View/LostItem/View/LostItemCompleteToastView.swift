//
//  LostItemCompleteToastView.swift
//  CurtainCall
//
//  Created by 김민석 on 2023/09/02.
//

import UIKit

final class LostItemCompleteToastView: UIView {
    ...
    private lazy var titleLabel: UILabel = {
        let label = UILabel()
        label.text = isSuccess ? "분실물 신고가 접수되었어요" : "오류로 인해 게시글 업로드에 실패했어요"
