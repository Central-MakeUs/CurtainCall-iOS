//
//  MyPageDetailOtherViewController.swift
//  CurtainCall
//
//  Created by 김민석 on 2023/09/09.
//
...
final class MyPageDetailOtherViewController: UIViewController {
    ...
    private func draw(info: PartyDetailResponse) {
        ...
        if let showAt = info.showAt {
            detailProductDateLabel.text = showAt.convertAPIDateToDateString()
        } else {
...
extension MyPageDetailOtherViewController: EditBottomSheetDelegate {
    func moveToEdit() {
...
extension MyPageDetailOtherViewController: DeletePopDelegate {
