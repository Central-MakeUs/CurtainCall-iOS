...
protocol PartyInPopupDelegate: AnyObject {
    func partyInButtonTapped()
}

final class PartyInPopup: UIViewController {
    ...
    private let completeButton: UIButton = {
        let button = UIButton()
        button.setTitle("네, 참여할래요", for: .normal)
    ...
    weak var delegate: PartyInPopupDelegate?
